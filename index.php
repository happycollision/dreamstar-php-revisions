...
<head>
	...
	<title>Home | Dreamstar Productions LLC.</title><?php
...
<body>
	<div class="containter">
		...
		<div class="content">
			<p class="PageTitle"><?php echo $Title; ?></p><?php #echo $HomePageOut; ?>
			<p>
				<img src="_JPG_Files/DES14-Dancer.jpg" style="width: 20%; float: left; border-radius: 10px; margin-right: 10px;">Dreamstar Productions LLC, doing business as Dreamstar Dance, is a dance competition that was created to provide the highest quality experience to each and every studio, teacher, performer, and family.
			</p>
			<p>
				At Dreamstar, we strive to bring America's dance talent together with experienced judges from all over the country in order for young dancers to receive the feedback they need to take their skills to the next level. Dreamstar offers the dance student the opportunity to perform for qualified judges in a constructive and friendly environment. We provide opportunities for talented dancers to attend master classes.
			</p>
			<p>
				We are an organization dedicated to helping young people improve self esteem, poise, and confidence through the art of dance. Our friendly, helpful staff will make this a rewarding experience for everyone attending.</p>
			<p>
			...
			<h2>Rebates</h2>
			<p>
				<b><span style="color: rgb(192, 0, 0);">Dreamstar Dance, a dance competition company, focused on celebrating excellence in dance, wants your studio to try our competition.</span></b>
				With this goal in mind, we are offering an introductory <b>10% REBATE</b>, when we receive your entry paperwork and payment 6 weeks prior to the competition.
			</p>
			<h2>Master Classes</h2>
			<p>
				We are also offering Master Classes during our competition weekend. Students signing up for Master Classes will receive a $10 discount if they are competing in the competition. <a class="dreamstar-links" href="masterclass.php">More Info</a>
			</p>
			<h3><a class="dreamstar-links" href="dancechallenge.php">Challenge of the Dance Stars</a></h3>
		</div><!-- End content	-->
		<div class="tourdates">
			<?php require_once("V2/_CSS_Files/dates.php");?>
		</div><!-- End tourdates -->
		<div class="twitter">
			<?php require_once("V2/_CSS_Files/twitter.php");?>
		</div><!-- End tourdates -->
		<div class="footer">
