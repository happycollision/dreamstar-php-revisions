  ...
  <tr>
    ...
    ?></li>
      ...
      <li><a href="aboutus.php">About Us</a>
        ...
        <li><a href="RulesAndRegulations.php">Rules &amp; Registration</a>
        <ul>
          ...
          <li><a href="RulesAndRegulations.php#NonPerformanceCategories">Non-Performance Categories</a></li>
          <li><a href="RulesAndRegulations.php#Scoring">Scoring</a></li>
          <li><a href="RulesAndRegulations.php#Awards">Awards</a></li>
        </ul>
      </li>
      
      <li> <a href="javascript:void(0)">Extras</a>
        <ul>
