...
<body>
  <h1 align="center" class="name">Competition Dates</h1><?php
  ...
  if ($num == 0){?>
  <ul class="tour-dates">
    <li class="tour-dates">Tour Dates Coming Soon</li><?php }?>
  </ul><a class="tour-dates" href="http://dreamstarnow.dancecompgenie.com/">Register Online Now!</a>
</body>
</html>