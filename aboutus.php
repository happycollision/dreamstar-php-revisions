...
<head>
  ...
  <meta content="Information about Dreamstar Productions LLC. A Family Oriented Dance Competition Company" name="description">
  <meta content="Dance Competition, Family Oriented, Dancing Competitions, About Dreamstar Dance Compeitition, Dance Dreamstar" name="keywords"><?php 
  # Load Layout
...
<body>
  <div class="containter">
    ...
    <div class="content">
      ...
      <div class="Bio-Container">
        <div class="Bio-Mug"><img alt="Headshot" class="Bio-Mug" src="/_JPG_Files/headshots/web-headshots/joe-goodall.jpg"></div>
        <div class="Bio-Name">
          Joe Goodall
        </div>
        <div class="Bio-Title">
          Co-Owner & Executive Director, Dreamstar Productions, LLC.
        </div>
        <div class="Bio-Info">
          <p>Joe is a graduate of St. Ambrose University in Davenport, IA. While at SAU he completed a Bachelors Degree majoring in Theatre & Theatre Education. During his college years he was active in the community working for Davenport North High School, as the Technical Director for the theatre department, as well as working for countless dance companies as light designer for their recitals.</p>
      ...
      <div class="Bio-Container">
        <div class="Bio-Mug"><img alt="Headshot" class="Bio-Mug" src="/_JPG_Files/headshots/web-headshots/joann-goodall.jpg"></div>
        <div class="Bio-Name">
          JoAnn Goodall
        </div>
        <div class="Bio-Title">
          Service Coordinator & Merchandiser, Dreamstar Productions, LLC.
        </div>
        <div class="Bio-Info">
      ...
      <div class="Bio-Container">
        <div class="Bio-Mug"><img alt="Headshot" class="Bio-Mug" src="/_JPG_Files/headshots/web-headshots/briony-schroeder.jpg"></div>
        <div class="Bio-Name">
          Briony Schroeder
        </div>
        <div class="Bio-Title">
